...
import type { Chef } from "./DataJson";  // Import Chef as a type
import Head from 'next/head';

function ChefComponent() {  // Change the component name to avoid conflict
  ...
  return (
    <>
      ...
      <div 
        style={{backgroundImage:'url("/unsplash_4ycv3Ky1ZZU.png")',backgroundSize:'cover',backgroundRepeat:'no-repeat'}} 
        className="h-[200px] text-white flex flex-col items-center justify-center"
      >
      ...
      <div className="mt-[100px] flex items-center justify-center">
        <div className='grid grid-cols-2 md:grid-cols-3 gap-[30px]'>
          {
            Team.map((item: Chef, index) => {  // Using Chef as type for Team items
              return (
                <div key={index}>
